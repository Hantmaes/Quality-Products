  ...
  <div class="container text-center text-md-left mt-5">
    ...
    <div class="row mt-3 dark-grey-text">
      ...
      <div class="col-md-3 col-lg-4 col-xl-3 mb-4">
        ...
        <!-- Content -->
        <h6 class="text-uppercase font-weight-bold">YDH DRINK COMPANY</h6>
        <hr class="teal accent-3 mb-4 mt-0 d-inline-block mx-auto" style="width: 60px;">
        <p>Platform for beer producers to selling their beers.</p>
      ...
      <div class="col-md-4 col-lg-3 col-xl-3 mx-auto mb-md-0 mb-4">
        ...
        <hr class="teal accent-3 mb-4 mt-0 d-inline-block mx-auto" style="width: 60px;">
        <p>
          <i class="fas fa-home mr-3"></i> Prague, Czech Republic</p>
        <p>
          <i class="fas fa-envelope mr-3"></i> info@final-project.test</p>
        <p>
